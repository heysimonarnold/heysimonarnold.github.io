...
class Game {
  constructor() {
    ...
    this.audio = {
      ...
      current: null,
      slow: new Howl({
        src: ["/explorations/escape-jaws/sounds/1.ogg"],
        loop: true,
        volume: 0,
      }),
      medium: new Howl({
        src: ["/explorations/escape-jaws/sounds/2.ogg"],
        loop: true,
        volume: 0,
      }),
      fast: new Howl({
        src: ["/explorations/escape-jaws/sounds/3.ogg"],
        loop: true,
        volume: 0,
      }),
      danger: new Howl({
        src: ["/explorations/escape-jaws/sounds/4.ogg"],
        loop: true,
        volume: 0,
      }),
      scream: new Howl({
        src: ["/explorations/escape-jaws/sounds/scream.ogg"],
        volume: 1,
      }),
    };
  ...
  setJawsObjective() {
    ...
    this.jaws.animation = gsap.to(this.dom.jaws, {
      ...
      onUpdate: throttle(() => this.mix(), 250),
    });
  }
